...
CREATE TABLE `作物品种表` (
  ...
  PRIMARY KEY (`品种ID`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='作物品种表';
...
(11, '草莓(章姬)', '蔷薇科草莓属', 120, '15-25°C / 60-75%', '温室草莓品种');
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='借用记录表';
...
(19, 11, 1, 3, '2026-06-18 12:44:39', '2026-06-19 00:00:00', NULL, '借用中', NULL, 1);
...
(5, 'EQ-T005', '榔头', 1, '中号/木柄', '把', 30, 5, '22.00', '工具库1-C'),
...
(11, 'EQ-C001', '育苗基质', 3, '50L/袋', '袋', 74, 10, '18.00', '耗材库A'),
...
(7, '007', 3, 9, '2026-06-18', 100, '生长期', '95.00', 2, '2026-06-18 11:56:42');
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='学生报名表';
...
(16, 3, 21, '已通过', '2026-02-22 15:30:00', NULL),
...
(82, 1, 39, '已通过', '2026-06-19 17:30:59', NULL),
(83, 2, 39, '待审核', '2026-06-19 17:31:03', NULL),
(84, 3, 39, '待审核', '2026-06-19 17:31:04', NULL),
(85, 4, 39, '待审核', '2026-06-19 17:31:04', NULL),
(86, 5, 39, '待审核', '2026-06-19 17:31:04', NULL),
(87, 6, 39, '待审核', '2026-06-19 17:31:04', NULL),
(88, 8, 39, '待审核', '2026-06-19 17:31:05', NULL),
(89, 2, 7, '已通过', '2026-06-19 17:42:18', NULL),
(90, 5, 7, '已通过', '2026-06-19 17:42:19', NULL),
(91, 4, 7, '已通过', '2026-06-19 17:42:20', NULL),
(92, 6, 7, '已通过', '2026-06-19 17:42:21', NULL),
(93, 8, 7, '已通过', '2026-06-19 17:42:21', NULL),
(94, 1, 46, '待审核', '2026-06-19 17:43:28', NULL),
(95, 3, 46, '待审核', '2026-06-19 17:43:28', NULL),
(96, 2, 46, '待审核', '2026-06-19 17:43:29', NULL),
(97, 4, 46, '待审核', '2026-06-19 17:43:30', NULL),
(98, 5, 46, '待审核', '2026-06-19 17:43:30', NULL),
(99, 6, 46, '待审核', '2026-06-19 17:43:30', NULL),
(100, 8, 46, '待审核', '2026-06-19 17:43:40', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='实训场地表';
...
(12, 'VN-12', '11', 1, '111.00', '1', '空闲', 'ZHANG', '');
...
(1, '小麦高产栽培技术实训', '学习小麦从播种到收获的全流程栽培技术', 4, 2, 2, '2026-03-02', '2026-06-30', 40, '进行中', '2026-06-17 19:34:27'),
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志表';
...
(46, 1, '场地', '新增', '实训场地表', 12, '新增场地 11', '2026-06-18 16:02:52'),
(47, 1, '作物', '新增', '作物品种表', 14, '系统管理员 新增了作物品种「YUEJI」', '2026-06-18 16:03:41'),
(48, 1, '作物', '删除', '作物品种表', 14, '系统管理员 删除了作物品种「YUEJI」', '2026-06-18 16:04:09'),
(49, 1, '用户', '新增', '用户表', 47, '系统管理员 新增了学生「乐乐」（账号：张涛）', '2026-06-18 16:04:46'),
(50, 1, '用户', '修改', '用户表', 47, '系统管理员 重置了 乐乐 的密码', '2026-06-18 16:05:01'),
(52, 12, '考勤', '新增', '签到记录表', 90, '郑美玲 签到成功（场次8）', '2026-06-18 16:20:26'),
(53, 12, '考勤', '新增', '签到记录表', 91, '郑美玲 签到成功（场次5）', '2026-06-18 16:20:29'),
(54, 12, '考勤', '新增', '签到记录表', 92, '郑美玲 签到成功（场次4）', '2026-06-18 16:20:31'),
(55, 15, '考勤', '新增', '签到记录表', 93, '周昊然 签到成功（场次5）', '2026-06-18 16:20:53'),
(56, 15, '考勤', '新增', '签到记录表', 94, '周昊然 签到成功（场次8）', '2026-06-18 16:20:55'),
(57, 2, '考勤', '新增', '考勤场次表', 12, '发布考勤场次（2026-06-19）', '2026-06-19 16:56:23'),
(58, 7, '考勤', '新增', '签到记录表', 95, '陈晓宇 签到成功（场次12）', '2026-06-19 16:56:40'),
(59, 2, '考勤', '新增', '考勤场次表', 13, '发布考勤场次（2026-06-19）', '2026-06-19 17:08:28'),
(60, 11, '考勤', '新增', '签到记录表', 96, '黄俊杰 签到成功（场次13）', '2026-06-19 17:08:41'),
(61, 2, '考勤', '新增', '考勤场次表', 14, '发布考勤场次（2026-06-20）', '2026-06-19 17:19:34'),
(62, 7, '考勤', '新增', '签到记录表', 97, '陈晓宇 签到成功（场次14）', '2026-06-19 17:19:44'),
(63, 7, '考勤', '新增', '签到记录表', 98, '陈晓宇 签到成功（场次13）', '2026-06-19 17:19:48'),
(64, 2, '考勤', '删除', '考勤场次表', 14, '张建国 删除了考勤场次（2026-06-20），清空了1条签到记录', '2026-06-19 17:20:05'),
(65, 2, '考勤', '删除', '考勤场次表', 13, '张建国 删除了考勤场次（2026-06-19），清空了2条签到记录', '2026-06-19 17:20:11'),
(66, 2, '考勤', '新增', '考勤场次表', 15, '发布考勤场次（2026-06-19）', '2026-06-19 17:30:43'),
(67, 39, '项目', '报名', '学生报名表', 82, '胡雪莹 申请报名项目「小麦高产栽培技术实训」', '2026-06-19 17:30:59'),
(68, 39, '项目', '报名', '学生报名表', 83, '胡雪莹 申请报名项目「玉米杂交育种实验」', '2026-06-19 17:31:03'),
(69, 39, '项目', '报名', '学生报名表', 84, '胡雪莹 申请报名项目「温室蔬菜无土栽培」', '2026-06-19 17:31:04'),
(70, 39, '项目', '报名', '学生报名表', 85, '胡雪莹 申请报名项目「土壤养分检测与分析」', '2026-06-19 17:31:04'),
(71, 39, '项目', '报名', '学生报名表', 86, '胡雪莹 申请报名项目「花卉育苗与养护」', '2026-06-19 17:31:04'),
(72, 39, '项目', '报名', '学生报名表', 87, '胡雪莹 申请报名项目「食用菌栽培技术」', '2026-06-19 17:31:04'),
(73, 39, '项目', '报名', '学生报名表', 88, '胡雪莹 申请报名项目「果树嫁接技术实训」', '2026-06-19 17:31:05'),
(74, 2, '项目', '审核通过', '学生报名表', 16, '张建国 审核通过了学生(ID=21)对项目(ID=3)的报名申请', '2026-06-19 17:42:00'),
(75, 7, '项目', '报名', '学生报名表', 89, '陈晓宇 申请报名项目「玉米杂交育种实验」', '2026-06-19 17:42:18'),
(76, 7, '项目', '报名', '学生报名表', 90, '陈晓宇 申请报名项目「花卉育苗与养护」', '2026-06-19 17:42:19'),
(77, 7, '项目', '报名', '学生报名表', 91, '陈晓宇 申请报名项目「土壤养分检测与分析」', '2026-06-19 17:42:20'),
(78, 7, '项目', '报名', '学生报名表', 92, '陈晓宇 申请报名项目「食用菌栽培技术」', '2026-06-19 17:42:21'),
(79, 7, '项目', '报名', '学生报名表', 93, '陈晓宇 申请报名项目「果树嫁接技术实训」', '2026-06-19 17:42:21'),
(80, 1, '项目', '审核通过', '学生报名表', 91, '系统管理员 审核通过了学生(ID=7)对项目(ID=4)的报名申请', '2026-06-19 17:42:51'),
(81, 1, '项目', '审核通过', '学生报名表', 92, '系统管理员 审核通过了学生(ID=7)对项目(ID=6)的报名申请', '2026-06-19 17:42:52'),
(82, 1, '项目', '审核通过', '学生报名表', 93, '系统管理员 审核通过了学生(ID=7)对项目(ID=8)的报名申请', '2026-06-19 17:42:53'),
(83, 1, '项目', '审核通过', '学生报名表', 90, '系统管理员 审核通过了学生(ID=7)对项目(ID=5)的报名申请', '2026-06-19 17:42:54'),
(84, 1, '项目', '审核通过', '学生报名表', 89, '系统管理员 审核通过了学生(ID=7)对项目(ID=2)的报名申请', '2026-06-19 17:42:55'),
(85, 46, '项目', '报名', '学生报名表', 94, '韩铭泽 申请报名项目「小麦高产栽培技术实训」', '2026-06-19 17:43:28'),
(86, 46, '项目', '报名', '学生报名表', 95, '韩铭泽 申请报名项目「温室蔬菜无土栽培」', '2026-06-19 17:43:28'),
(87, 46, '项目', '报名', '学生报名表', 96, '韩铭泽 申请报名项目「玉米杂交育种实验」', '2026-06-19 17:43:29'),
(88, 46, '项目', '报名', '学生报名表', 97, '韩铭泽 申请报名项目「土壤养分检测与分析」', '2026-06-19 17:43:30'),
(89, 46, '项目', '报名', '学生报名表', 98, '韩铭泽 申请报名项目「花卉育苗与养护」', '2026-06-19 17:43:30'),
(90, 46, '项目', '报名', '学生报名表', 99, '韩铭泽 申请报名项目「食用菌栽培技术」', '2026-06-19 17:43:30'),
(91, 46, '项目', '报名', '学生报名表', 100, '韩铭泽 申请报名项目「果树嫁接技术实训」', '2026-06-19 17:43:40'),
(92, 1, '用户', '修改', '用户表', 26, '系统管理员 编辑了用户「张浩然」（账号：s020）：手机号: None → 13900000019', '2026-06-19 21:27:20'),
(93, 1, '用户', '修改', '用户表', 26, '系统管理员 编辑了用户「张浩然」（账号：s020）：手机号: 13900000019 → 13900000020', '2026-06-19 21:27:40'),
(94, 1, '项目', '审核通过', '学生报名表', 82, '系统管理员 审核通过了学生(ID=39)对项目(ID=1)的报名申请', '2026-06-19 21:27:55'),
(95, 1, '器材', '修改', '借用记录表', 19, '系统管理员 审批通过器材借用（育苗基质，借出3件，库存74）', '2026-06-19 21:28:31'),
(96, 1, '器材', '修改', '器材档案表', 5, '系统管理员 修改了器材「榔头」信息', '2026-06-19 21:28:56'),
(97, 2, '作物', '修改', '作物品种表', 11, '张建国 编辑了作物「草莓(章姬)」：周期: 100 → 120', '2026-06-19 21:38:53'),
(98, 2, '项目', '修改', '实训项目表', 1, '张建国 编辑了项目「小麦高产栽培技术实训」：开始日期: 2026-03-02 → 2026-03-02；结束日期: 2026-06-30 → 2026-06-30；人数上限: 15 → 40', '2026-06-19 21:48:53');
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统用户表';
...
(24, 's018', '刘思远', '2022001018', 3, 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', '13900000018', NULL, 1, '2026-06-18 11:22:10'),
(25, 's019', '王雨晴', '2022001019', 3, 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', '13900000019', NULL, 1, '2026-06-18 11:22:10'),
(26, 's020', '张浩然', '2022001020', 3, 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', '13900000020', NULL, 1, '2026-06-18 11:22:10'),
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='病虫害防治表';

INSERT INTO `病虫害防治表` (`防治ID`, `批次ID`, `发现日期`, `病虫害类型`, `严重程度`, `防治措施`, `防治结果`, `记录人ID`) VALUES
(1, 1, '2026-03-15', '蚜虫', '中度', '喷洒10%吡虫啉可湿性粉剂1500倍液，间隔7天连续喷洒2次，同时悬挂黄色粘虫板诱杀成虫', '已解决', 7),
(2, 2, '2026-04-02', '稻飞虱', '严重', '使用25%扑虱灵可湿性粉剂1000倍液喷雾，结合田间灌深水灭蛹，施药后3天检查效果', '处理中', 8),
(3, 3, '2026-03-20', '叶斑病', '轻度', '喷洒50%多菌灵可湿性粉剂800倍液，剪除严重病叶集中销毁，加强通风透光', '已解决', 9),
(4, 4, '2026-04-10', '白粉病', '中度', '使用25%三唑酮可湿性粉剂1500倍液喷雾，降低菇棚湿度至75%以下，增加通风换气次数', '需持续观察', 10),
(5, 5, '2026-05-05', '红蜘蛛', '严重', '喷洒1.8%阿维菌素乳油2000倍液+20%哒螨灵可湿性粉剂1500倍液混合喷雾，重点喷叶背，间隔5天重复一次', '已解决', 11),
(6, 1, '2026-05-18', '白粉病', '轻度', '喷洒25%粉锈宁可湿性粉剂1000倍液，摘除底部老叶改善通风，控制氮肥用量增施磷钾肥', '已解决', 12),
(7, 2, '2026-06-01', '纹枯病', '中度', '使用5%井冈霉素水剂500倍液喷施茎基部，结合晒田降低田间湿度，清除田边杂草减少病源', '处理中', 13),
(8, 5, '2026-06-12', '蚜虫', '轻度', '释放瓢虫进行生物防治（每株2-3头），同时喷洒0.3%苦参碱水剂500倍液作为辅助', '已解决', 14);
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='签到记录表';
...
(23, 4, 18, '2026-03-01 08:25:00', '出勤'),
...
(30, 6, 20, '2026-03-10 08:50:00', '出勤'),
...
(90, 8, 12, '2026-06-18 16:20:26', '迟到'),
(91, 5, 12, '2026-06-18 16:20:29', '迟到'),
(92, 4, 12, '2026-06-18 16:20:31', '迟到'),
(93, 5, 15, '2026-06-18 16:20:53', '迟到'),
(94, 8, 15, '2026-06-18 16:20:55', '迟到'),
(95, 12, 7, '2026-06-19 16:56:40', '出勤');
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='考勤场次表';
...
(4, 2, '2026-03-01', '8:00:00', '11:30:00', '5号试验田', 14, 4, '2026-06-17 19:34:27'),
(5, 2, '2026-03-08', '8:00:00', '11:30:00', '5号试验田', 13, 4, '2026-06-17 19:34:27'),
(6, 3, '2026-03-10', '8:30:00', '12:00:00', '1号温室', 3, 2, '2026-06-17 19:34:27'),
(7, 3, '2026-03-17', '8:30:00', '12:00:00', '1号温室', 7, 2, '2026-06-17 19:34:27'),
(8, 4, '2026-03-15', '14:00:00', '17:30:00', '土壤分析实验室', 2, 6, '2026-06-17 19:34:27'),
(10, 3, '2026-06-18', '8:00:00', '11:30:00', '1号大棚', 1, 2, '2026-06-18 11:58:15'),
(11, 3, '2026-06-18', '8:00:00', '11:30:00', '1', 1, 2, '2026-06-18 12:48:15'),
(12, 3, '2026-06-19', '10:00:30', '23:24:46', '1号温室', 1, 2, '2026-06-19 16:56:23'),
(15, 2, '2026-06-19', '17:00:00', '23:30:00', '', 0, 2, '2026-06-19 17:30:43');


-- ------------------------------------------------------------
-- Table: 视图_场地使用情况
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `视图_场地使用情况`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `视图_场地使用情况` AS select `v`.`场地编号` AS `场地编号`,`v`.`场地名称` AS `场地名称`,`vt`.`类型名称` AS `场地类型`,`v`.`使用状态` AS `使用状态`,`v`.`责任人` AS `责任人`,`v`.`面积平米` AS `面积平米`,count(distinct `vb`.`预约ID`) AS `预约次数`,count(distinct `cb`.`批次ID`) AS `培育批次数` from (((`实训场地表` `v` join `场地类型表` `vt` on((`v`.`类型ID` = `vt`.`类型ID`))) left join `场地预约表` `vb` on((`v`.`场地ID` = `vb`.`场地ID`))) left join `培育批次表` `cb` on((`v`.`场地ID` = `cb`.`场地ID`))) group by `v`.`场地ID`;

INSERT INTO `视图_场地使用情况` (`场地编号`, `场地名称`, `场地类型`, `使用状态`, `责任人`, `面积平米`, `预约次数`, `培育批次数`) VALUES
('VN-001', '1号温室大棚', '温室大棚', '空闲', '张建国', '250.00', 1, 1),
('VN-002', '2号温室大棚', '温室大棚', '使用中', '李美华', '180.00', 1, 1),
('VN-003', '3号温室大棚', '温室大棚', '空闲', '张建国', '250.00', 1, 1),
('VN-004', '东区试验田A区', '试验农田', '使用中', '王志强', '500.00', 1, 0),
('VN-005', '东区试验田B区', '试验农田', '空闲', '王志强', '450.00', 1, 1),
('VN-006', '西区试验田', '试验农田', '维护中', '赵春梅', '600.00', 1, 0),
('VN-007', '植物生理实验室', '实验室', '空闲', '刘明辉', '80.00', 1, 1),
('VN-008', '土壤分析实验室', '实验室', '空闲', '刘明辉', '60.00', 0, 0),
('VN-009', '南示范田', '试验农田', '使用中', '赵春梅', '800.00', 0, 1),
('VN-010', '微生物培养室', '实验室', '空闲', '刘明辉', '40.00', 0, 0),
('VN-011', '4号温室大棚', '温室大棚', '使用中', '管理员', '666.00', 0, 1),
('VN-12', '11', '温室大棚', '空闲', 'ZHANG', '111.00', 0, 0);


-- ------------------------------------------------------------
-- Table: 视图_学生成绩
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `视图_学生成绩`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `视图_学生成绩` AS select `u`.`学号工号` AS `学号工号`,`u`.`真实姓名` AS `真实姓名`,`p`.`项目名称` AS `项目名称`,`en`.`综合成绩` AS `综合成绩`,(case when (`en`.`综合成绩` >= 90) then '优秀' when (`en`.`综合成绩` >= 75) then '良好' when (`en`.`综合成绩` >= 60) then '及格' else '不及格' end) AS `成绩等级` from ((`学生报名表` `en` join `用户表` `u` on((`en`.`学生ID` = `u`.`用户ID`))) join `实训项目表` `p` on((`en`.`项目ID` = `p`.`项目ID`))) where ((`en`.`报名状态` = '已通过') and (`en`.`综合成绩` is not null));


-- ------------------------------------------------------------
-- Table: 视图_库存预警
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `视图_库存预警`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `视图_库存预警` AS select `e`.`器材编号` AS `器材编号`,`e`.`器材名称` AS `器材名称`,`c`.`分类名称` AS `器材分类`,`e`.`当前库存` AS `当前库存`,`e`.`最低库存` AS `最低库存`,`e`.`单位` AS `单位`,(case when (`e`.`当前库存` = 0) then '缺货' when (`e`.`当前库存` <= `e`.`最低库存`) then '预警' else '正常' end) AS `库存状态` from (`器材档案表` `e` join `器材分类表` `c` on((`e`.`分类ID` = `c`.`分类ID`))) where (`e`.`当前库存` <= `e`.`最低库存`);

INSERT INTO `视图_库存预警` (`器材编号`, `器材名称`, `器材分类`, `当前库存`, `最低库存`, `单位`, `库存状态`) VALUES
('EQ-T002', '修枝剪', '农具', 6, 10, '把', '预警'),
('EQ-T003', '电动剪枝机', '农具', 1, 2, '台', '预警'),
('EQ-I004', '光合仪', '仪器', 2, 5, '台', '预警');


-- ------------------------------------------------------------
-- Table: 视图_考勤统计
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `视图_考勤统计`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `视图_考勤统计` AS select `p`.`项目名称` AS `项目名称`,(select count(0) from `学生报名表` `en` where ((`en`.`项目ID` = `p`.`项目ID`) and (`en`.`报名状态` = '已通过'))) AS `应到人数`,count(distinct `a`.`学生ID`) AS `实到人数`,concat(round(((count(distinct `a`.`学生ID`) / nullif((select count(0) from `学生报名表` `en` where ((`en`.`项目ID` = `p`.`项目ID`) and (`en`.`报名状态` = '已通过'))),0)) * 100),1),'%') AS `出勤率` from ((`实训项目表` `p` left join `考勤场次表` `s` on((`p`.`项目ID` = `s`.`项目ID`))) left join `签到记录表` `a` on(((`s`.`场次ID` = `a`.`场次ID`) and (`a`.`签到状态` in ('出勤','迟到'))))) group by `p`.`项目ID`;

INSERT INTO `视图_考勤统计` (`项目名称`, `应到人数`, `实到人数`, `出勤率`) VALUES
('小麦高产栽培技术实训', 7, 9, '128.6%'),
('玉米杂交育种实验', 19, 14, '73.7%'),
('温室蔬菜无土栽培', 4, 9, '225.0%'),
('土壤养分检测与分析', 19, 2, '10.5%'),
('花卉育苗与养护', 19, 0, '0.0%'),
...
-- Table: 视图_逾期未还
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `视图_逾期未还`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `视图_逾期未还` AS select `b`.`借用ID` AS `借用ID`,`e`.`器材名称` AS `器材名称`,`u`.`真实姓名` AS `借用人`,`b`.`借用数量` AS `借用数量`,`b`.`借用日期` AS `借用日期`,`b`.`应还日期` AS `应还日期`,(to_days(now()) - to_days(`b`.`应还日期`)) AS `逾期天数` from ((`借用记录表` `b` join `器材档案表` `e` on((`b`.`器材ID` = `e`.`器材ID`))) join `用户表` `u` on((`b`.`用户ID` = `u`.`用户ID`))) where ((`b`.`借用状态` = '借用中') and (`b`.`应还日期` < now()));

INSERT INTO `视图_逾期未还` (`借用ID`, `器材名称`, `借用人`, `借用数量`, `借用日期`, `应还日期`, `逾期天数`) VALUES
(3, '喷雾器', '林小芳', 1, '2026-03-09 08:00:00', '2026-03-16 00:00:00', 95),
(4, '土壤pH计', '刘思雨', 1, '2026-03-15 14:00:00', '2026-03-22 00:00:00', 89),
(19, '育苗基质', '系统管理员', 3, '2026-06-18 12:44:39', '2026-06-19 00:00:00', 0);
